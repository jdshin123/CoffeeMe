...
public class AeroPress extends AppCompatActivity {
    ...
    {
        Button clicker = (Button) findViewById(R.id.button11);
        final TextView label = (TextView) findViewById(R.id.textView17);
    ...
    {
        Button clicker = (Button) findViewById(R.id.button12);
        final TextView label = (TextView) findViewById(R.id.textView18);
        continueThread = true;
    ...
    public void OnButtonClickAndMultiplyDisplay(View view){
        EditText er = (EditText)findViewById(R.id.aeroPressInput);
        String s1;
